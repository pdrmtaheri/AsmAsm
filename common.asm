...
%define INST_INC_OPCODE 0b11111110
%define INST_INC_MOD_REG_RM 0b00000000

%define INST_DEC_LEN 4
%define INST_DEC_OPCODE 0b11111110
%define INST_DEC_MOD_REG_RM 0b00001000

%define INST_JMP_LEN 4
%define INST_JMP_OPCODE 0b11111111
%define INST_JMP_MOD_REG_RM 0b00100000

%define INST_CALL_LEN 5
%define INST_CALL_OPCODE 0b11111111
%define INST_CALL_MOD_REG_RM 0b00010000
